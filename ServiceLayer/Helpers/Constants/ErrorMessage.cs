...
namespace ServiceLayer.Helpers.Constants
{
	public class ErrorMessage
	{
        ...
        public const string IdShouldBeNum = "Please, add ID which is number: ";
        ...
        public const string DepNameNotFound = "There isn't employee with this department name";
        ...
        public const string CorrectAge = "Age must be between 18 and 70! Try again: ";
        public const string CorrectID = "Please, add correct ID: ";
        public const string CorrectDepartment = "Please, add correct department: ";
        public const string CorrectAddress = "Please, add correct Address: ";
        ...
        public const string CorrectEmpAddress = "Please, add correct Employee Address: ";
        public const string DepNotExistWithGivenID = "There isn't department with given ID: ";
        public const string EmpNotFoundWithGivenDepID = "There isn't department with given ID: ";
        public const string CorrectEmpAge = "Please, add correct Age which is number: ";
        public const string EmpNotFoundWithNameOrSurname = "Employee not found with given name or surname in given database: ";
        public const string DepIsFull = "Department is full!!!";
    }
}